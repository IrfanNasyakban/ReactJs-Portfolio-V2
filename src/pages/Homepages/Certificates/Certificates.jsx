          ...
          {certificates.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {certificates.map((certificate) => {
                const hasLiveLink = certificate.link && certificate.link !== '-' && certificate.link !== '';
                const hasGithubLink = certificate.github && certificate.github !== '-' && certificate.github !== '';
    
                return (
                  <div key={certificate.id} className="border border-slate-600 hover:border-purple-500 transition-all duration-300 group">
                    {/* Certificate Image */}
