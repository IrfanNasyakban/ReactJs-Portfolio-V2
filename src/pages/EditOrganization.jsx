...
const EditOrganization = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`${apiUrl}/organizations/${id}`, formDataToSend, {
        headers: { 
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Loading organization data...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                Update your organizational activity information
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit}>
            <div className={`rounded-xl border p-8 ${isDark ? 'bg-[#282C33] border-gray-700' : 'bg-white border-gray-200'}`}>
              ...
              >
                ...
                >
                  <FaSave />
                  <span>{loading ? 'Updating...' : 'Update Organization'}</span>
                </button>
                <button
                  type="button"
          ...
          >
            <p className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
              <strong>Tip:</strong> You can update the organization information without changing the logo. To replace the logo, click "Upload New Logo" button or drag and drop a new file.
            </p>
          </motion.div>
        </motion.div>
      </div>
