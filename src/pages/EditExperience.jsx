...
const EditExperience = () => {
  ...
  const getExperienceById = async () => {
    try {
      ...
      const response = await axios.get(`${apiUrl}/experience/${id}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`${apiUrl}/experience/${id}`, formData, {
        headers: { 
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Loading experience data...</p>
        </div>
      </div>
    );
  }
        ...
        >
          ...
          >
            <p className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
              <strong>Tip:</strong> Keep your experience information up to date. Highlight your achievements and quantifiable results to make your profile stand out.
            </p>
          </motion.div>
        </motion.div>
      </div>
