    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Loading certificate data...</p>
        </div>
      </div>
    );
  }
        ...
        >
          ...
          >
            <p className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
              <strong>Tip:</strong> You can update the certificate information without changing the image. If you want to replace the image, simply upload a new one.
            </p>
          </motion.div>
        </motion.div>
      </div>
