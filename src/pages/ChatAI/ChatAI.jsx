          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div onClick={() => navigate('/my-girlfriend')} className="w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-purple-500/30 bg-purple-500/10 rounded-lg p-4">
                  <p className="text-xs text-purple-300">
                    💡 Tip: Ask specific questions about projects, skills, or experience!
                  </p>
                </div>
              </div>
            </motion.div>
